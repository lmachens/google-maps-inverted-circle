...
InvertedCircle.prototype.addCenter_ = function() {
  ...
  var me = this;
/*
  google.maps.event.addListener(center_marker, 'dragstart', function() {
    var icon = me.get('center_marker').getIcon();
    icon.origin = new google.maps.Point(0,20);
    me.get('center_marker').setIcon(icon);
  });
